...
## To install module manually by dragging up zip file, please download [.zip archive](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop-1.7/1.2.50/postfinancecheckout.zip) of module with correct structure required by Prestashop installation.
...
* [English](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop-1.7/1.2.50/docs/en/documentation.html)
...
Please see the [license file](https://github.com/pfpayments/prestashop-1.7/blob/1.2.50/LICENSE) for more information.

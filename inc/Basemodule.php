...
class PostFinanceCheckoutBasemodule
{
    ...
    const CK_CHECKOUT_TYPE = 'PFC_CHECKOUT_TYPE';
     ...
     * @return string
     */
    public static function handleSaveCheckoutTypeSettings(PostFinanceCheckout $module)
    {
        $output = "";
    ...
    public static function getCheckoutTypeForm(PostFinanceCheckout $module)
    {
        return array(
            'legend' => array(
     ...
     * @return mixed[]
     */
    public static function getCheckoutTypeConfigValues(PostFinanceCheckout $module)
    {
        $values = array();
        if (! $module->getContext()->shop->isFeatureActive() || $module->getContext()->shop->getContext() == Shop::CONTEXT_SHOP) {

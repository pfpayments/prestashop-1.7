 ...
 */
class PostFinanceCheckout_DownloadHelper
{
    ...
    public static function downloadInvoice($order)
    {
        ...
        if ($transactionInfo != null && in_array(
            ...
            $service = new \PostFinanceCheckout\Sdk\Service\TransactionService(PostFinanceCheckout_Helper::getApiClient());
    ...
    {
        $transactionInfo = PostFinanceCheckout_Helper::getTransactionInfoForOrder($order);
        if ($transactionInfo != null && $transactionInfo->getState() == \PostFinanceCheckout\Sdk\Model\TransactionState::FULFILL) {
            $service = new \PostFinanceCheckout\Sdk\Service\TransactionService(PostFinanceCheckout_Helper::getApiClient());

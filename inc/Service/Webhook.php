...
class PostFinanceCheckout_Service_Webhook extends PostFinanceCheckout_Service_Abstract {
	...
	public function __construct(){
	    $this->webhookEntities[1487165678181] = new PostFinanceCheckout_Webhook_Entity(1487165678181, 'Manual Task', 
				array(
	    ...
	    $this->webhookEntities[1472041857405] = new PostFinanceCheckout_Webhook_Entity(1472041857405, 'Payment Method Configuration', 
				array(
				...
				), 'PostFinanceCheckout_Webhook_MethodConfiguration', true);
	    $this->webhookEntities[1472041829003] = new PostFinanceCheckout_Webhook_Entity(1472041829003, 'Transaction', 
				array(
	    ...
	    $this->webhookEntities[1472041819799] = new PostFinanceCheckout_Webhook_Entity(1472041819799, 'Delivery Indication', 
				array(
	    ...
	    $this->webhookEntities[1472041831364] = new PostFinanceCheckout_Webhook_Entity(1472041831364, 'Transaction Completion', 
				array(
	    ...
	    $this->webhookEntities[1472041867364] = new PostFinanceCheckout_Webhook_Entity(1472041867364, 'Transaction Void', 
				array(
	    ...
	    $this->webhookEntities[1472041839405] = new PostFinanceCheckout_Webhook_Entity(1472041839405, 'Refund', 
				array(
	    ...
	    $this->webhookEntities[1472041806455] = new PostFinanceCheckout_Webhook_Entity(1472041806455, 'Token', 
				array(
					\PostFinanceCheckout\Sdk\Model\CreationEntityState::ACTIVE,
					\PostFinanceCheckout\Sdk\Model\CreationEntityState::DELETED,
					\PostFinanceCheckout\Sdk\Model\CreationEntityState::DELETING,
	    ...
	    $this->webhookEntities[1472041811051] = new PostFinanceCheckout_Webhook_Entity(1472041811051, 'Token Version', 
				array(

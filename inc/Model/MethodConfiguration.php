...
class PostFinanceCheckout_Model_MethodConfiguration extends ObjectModel
{
    ...
    public $fee_base = PostFinanceCheckout::TOTAL_MODE_BOTH_INC;
     ...
     * @param int $id
     * @param int $shopId
     * @return PostFinanceCheckout_Model_MethodConfiguration | false
     */

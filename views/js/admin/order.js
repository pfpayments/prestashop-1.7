...
jQuery(function($) {
	...
	$('#postfinancecheckout_update').off('click.postfinancecheckout').on('click.postfinancecheckout', 
		    updatePostFinanceCheckout);	
	$('#postfinancecheckout_void').off('click.postfinancecheckout').on('click.postfinancecheckout', 
	    showPostFinanceCheckoutVoid);			
	$("#postfinancecheckout_completion").off('click.postfinancecheckout').on('click.postfinancecheckout', 
	    showPostFinanceCheckoutCompletion);
	$('#postfinancecheckout_completion_submit').off('click.postfinancecheckout').on('click.postfinancecheckout',
		executePostFinanceCheckoutCompletion);
    }
    
    function showPostFinanceCheckoutInformationSuccess(msg){
	showPostFinanceCheckoutInformation(msg, postfinancecheckout_msg_general_title_succes, postfinancecheckout_btn_info_confirm_txt, 'dark_green', function(){window.location.replace(window.location.href);});	
   }
    
    function showPostFinanceCheckoutInformationFailures(msg){
	showPostFinanceCheckoutInformation(msg, postfinancecheckout_msg_general_title_error, postfinancecheckout_btn_info_confirm_txt, 'dark_red', function(){window.location.replace(window.location.href);});	
   }
